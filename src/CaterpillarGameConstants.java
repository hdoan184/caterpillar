...
public interface CaterpillarGameConstants {
	...
	public static final int GROWTH_SPURT = 20;

	// Thickness of the caterpillar
	public static final int CATERPILLAR_WIDTH = 15;

	// Number of good cabbages
	public static final int N_GOOD_CABBAGES = 16;

	// Number of bad cabbages
	public static final int N_BAD_CABBAGES = 16;
	...
	// Width of the fence
	public static final int FENCE_WIDTH = 15;
	
	// x - coord of the fence
	public static final int FENCE_START_POINT = 150;
	
	// Period of the animation (in ms)
	public static final int ANIMATION_PERIOD = 140;
	
	// Reduction of the period of the animation (in ms)
	public static final int ANIMATION_PERIOD_REDUCTION = 15;
}